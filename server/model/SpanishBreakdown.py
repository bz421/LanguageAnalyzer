...
SpanishBreakdown = Blueprint('breakdown', __name__)
...
@SpanishBreakdown.route('/api/getSubj', methods=['POST'])
...
@SpanishBreakdown.route('/api/getVerb', methods=['POST'])
...
@SpanishBreakdown.route('/api/getAdj', methods=['POST'])
...
@SpanishBreakdown.route('/api/getObj', methods=['POST'])
def getObjects():
    data = request.get_json()
